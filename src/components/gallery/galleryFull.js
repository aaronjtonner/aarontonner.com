    ...
    <Section>
      <Container className="spacing-lg">
        <>
          <ProjectOverview>
            <StaticImage
              src={"../../images/projects/klaad-mockup-1.png"}
            ...
            <ProjectOverviewText className="spacing">
              <div>
                <a
                  ...
                  href="https://www.klaadglass.ca"
                  target="_blank"
                >
                  www.klaadglass.ca
                </a>
                <h3>KLAAD Glass Ltd.</h3>
              </div>
              <p>{/* royco project info */}</p>
              <AnchorPrimary href="https://www.klaadglass.ca/" target="_blank">
                visit live website &#8594;
              </AnchorPrimary>
            </ProjectOverviewText>
          </ProjectOverview>
          <ProjectOverview>
            <StaticImage
              src={"../../images/projects/tnal-mockup.png"}
              alt="web design project"
              objectFit="cover"
              placeholder="blurred"
            />
            <ProjectOverviewText className="spacing">
              <div>
                <a
                  className="inline-link"
                  href="https://www.truenorthautoloans.com"
                  target="_blank"
                >
                  www.truenorthautoloans.com
                </a>
                <h3>true north auto loans</h3>
              </div>
              <p>{/* royco project info */}</p>
              <AnchorPrimary
                href="https://www.truenorthautoloans.com/"
          ...
          <ProjectOverview>
            <StaticImage
              src={"../../images/projects/mrr-mockup.png"}
              alt="web design project"
              objectFit="cover"
              placeholder="blurred"
            />
            <ProjectOverviewText className="spacing">
              <div>
                <a
                  className="inline-link"
                  href="https://www.mistyridgeretreatbandb.com"
                  target="_blank"
                >
                  www.mistyridgeretreatbandb.com
                </a>
                <h3>misty ridge retreat B&B</h3>
              </div>
              <p>{/* royco project info */}</p>
              <AnchorPrimary
                href="https://www.mistyridgeretreatbandb.com/"
          ...
          <ProjectOverview>
            <StaticImage
              src={"../../images/projects/pmm-mockup-1.png"}
              alt="web design project"
              objectFit="cover"
              placeholder="blurred"
            />
            <ProjectOverviewText className="spacing">
              <div>
                <a
                  ...
                  target="_blank"
                >
                  www.bookwithkathryn.com
                </a>
                <h3>pacha mamma massage & sound therapy</h3>
              </div>
              <p>{/* royco project info */}</p>
              <AnchorPrimary
                href="https://www.bookwithkathryn.com/"
          ...
          <ProjectOverview>
            <StaticImage
              src={"../../images/projects/3drt-mockup.png"}
              alt="web design project"
              objectFit="cover"
              placeholder="blurred"
            />
            <ProjectOverviewText className="spacing">
              <div>
                <a
                  className="inline-link"
                  href="https://www.3drtinc.com"
                  target="_blank"
                >
                  www.3drtinc.com
                </a>
                <h3>3'D revolution technologies Inc.</h3>
              </div>
              <p>{/* royco project info */}</p>
              <AnchorPrimary href="https://www.3drtinc.com/" target="_blank">
                visit live website &#8594;
              </AnchorPrimary>
            </ProjectOverviewText>
          </ProjectOverview>
